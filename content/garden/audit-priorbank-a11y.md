...
![Карусель с рекламой акций банка](/audit/prior/2.webp)
...
![Фокус на кнопке Войти формы логина](/audit/prior/3.webp)
...
![Фокус на кнопке Регистрация формы логина](/audit/prior/4.webp)
...
![Модальное окно регистрации и кнопка закрыть с подписью Close](/audit/prior/6.webp)
...
![Проверка контраста цвета через CCA](/audit/prior/5.webp)
...
![Фокус на контролах управления каруселью в включенным VoiceOver](/audit/prior/8.webp)
...
![Фокус остался на кнопке Регистрация после открытия модального окна](/audit/prior/9.webp)
...
![Фокус остался на кнопке Регистрация после открытия модального окна](/audit/prior/10.webp)
...
![Нет уведомления от скринридера о появившихся ошибках на форме регистрации](/audit/prior/11.webp)
...
![Номер телефона диспетчера диктуется скринридером без контекста](/audit/prior/12.webp)

![Кнопка подкрутки вверх не имеет подписи](/audit/prior/13.webp)
...
![Компоненты дебетовых карт](/audit/prior/14.webp)
...
![Скринридер озвучивает таблицу моих продуктов - столбец тип карты](/audit/prior/15.webp)

Ок, в последнем столбце мне удается все-таки услышать, сколько денег у меня на счету.

![Скринридер озвучивает сумму на карте](/audit/prior/16.webp)
...
![Axe DevTools показывает 12 ошибок на странице логина](/audit/prior/17.webp)

![Axe DevTools показывает 14 ошибок на странице личного кабинета](/audit/prior/18.webp)
...
![WAVE показывает 16 ошибок на странице логина](/audit/prior/20.webp)
...
![Lighthouse подсвечивает проблемы с размерами контролов управления каруселью](/audit/prior/23.webp)
...
![Фото панели банкомала со шрифтом Брайля](/audit/prior/24.webp)
