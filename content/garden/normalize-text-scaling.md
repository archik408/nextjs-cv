...
Теперь можно реализовать в проекте отдельный механизм контроля масштабирования текста в runtime (`textScaleManager`) как защиту layout в WebView: `data-original-text-size` плюс наблюдение за DOM.
