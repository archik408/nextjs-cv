...
Легендарная резиновая уточка на столе многих программистов тоже обязана своим появлением этой книге.

Это называется [«метод утенка»](https://ru.wikipedia.org/wiki/%D0%9C%D0%B5%D1%82%D0%BE%D0%B4_%D1%83%D1%82%D1%91%D0%BD%D0%BA%D0%B0). Идея в том, чтобы был кто-то (даже неодушевлённый), кому можно адресовать вопрос, ведь правильно сформулированная проблема — это половина решения.

Утки были подарками на многих IT-конференциях, их продают на маркетплейсах в разных раскрасках и сеттингах. Это стало важной частью гиковской культуры, хотя, возможно, многие и не знают, откуда растут ноги у этого явления. Я не фанат этой концепции. Кажется, она была актуальна до появления Google, StackOverflow и ChatGPT. Теперь я могу задать вопрос им или коллегам — сегодня редко кто создаёт программы в полном одиночестве (сказал я, который теперь сидит дома на удаленке один без офиса). Хотя сама практика «объясни проблему вслух» по-прежнему работает — уточка просто сменила форму.

**С недавних пор у меня, кстати, появился свой бэт-утёнок: сын подарил мне его на день рождения.**

![Мой бэт-утенок](/garden/pragmatic/photo_2026-08-19_13-13-22.webp)
