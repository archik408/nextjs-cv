...
![Подвал сайта в котором отсутствуют ссылки на Заявление о доступности](/audit/wildberries/1.webp)
...
![Часть исходного кода где явно прописан стиль :focus { outline: none }](/audit/wildberries/3.webp)
...
![Ссылка Работа в WB никак не выделена, хотя в фокусе](/audit/wildberries/2.webp)
...
![Боковое меню портала в открытом состоянии](/audit/wildberries/4.webp)
...
![Фильтры открыты, но навигация продолжается под подложкой](/audit/wildberries/5.webp)
...
![Белый текст на светло-сером фоне (вторичная подпись на карточке товара)](/audit/wildberries/7.webp)
...
![Пункты меню «Заказы», «Избранное», «Профиль», «Корзина»](/audit/wildberries/8.webp)
...
![Фокус на карточке товара в каталоге в режиме плохого зрения](/audit/wildberries/6.webp)
...
![VoiceOver озвучивает цену товара](/audit/wildberries/9.webp)
...
![VoiceOver озвучивает кнопку добавления в корзину «Послезавтра»](/audit/wildberries/10.webp)
...
![Нотификация о добавлении товара в корзину игнорируется VoiceOver](/audit/wildberries/12.webp)

![Неподписанные «кнопки» с цифрой посередине счетчик товара](/audit/wildberries/11.webp)
...
![Попытка нажать в корзине «Заказать» и в ответ тишина от VoiceOver](/audit/wildberries/13.webp)
...
![Результаты сканирования Deque Axe](/audit/wildberries/14.webp)

![Результаты сканирования Deque Axe](/audit/wildberries/15.webp)
...
![Результаты сканирования WAVE](/audit/wildberries/16.webp)
