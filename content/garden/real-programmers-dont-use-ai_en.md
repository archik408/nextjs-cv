---
title: Real programmers don't use AI
description: The historical paradox of demand for engineers — from Pascal and the PC to AI. Stacks die, the profession does not. The recent layoffs are about COVID-era headcount and the economic cycle, not the end of engineering.
date: 2026-08-16
...
> — Detective Spooner, _I, Robot_ (2004)
...
![A classic Apple Macintosh next to an IBM PC, both powered on](/garden/real-programmers-dont-use-ai/ibm-vs-mac.webp)
...
![The Turbo Pascal 7.0 IDE: blue DOS screen with the About dialog open](/garden/real-programmers-dont-use-ai/turbo-pascal.webp)
...
Globally, [SlashData](https://www.slashdata.co/post/global-developer-population-trends-2025-how-many-developers-are-there) put the developer community at roughly **31 million** at the start of **2022** and around **47.2 million** at the start of **2025**. [Wikipedia](https://en.wikipedia.org/wiki/Software_engineering_demographics), citing industry estimates, lands in the same order of magnitude. The methodologies differ. The direction, again, only points one way.

## This isn't just an IT thing

The same trick — "technology will kill this profession" — keeps repeating outside of code, too.

In the early 2010s, and especially between 2011 and 2015, it seemed almost self-evident that autopilots and driverless rigs would wipe out truck driving. People wrote about the millions of jobs that were about to vanish. More than a decade has passed. The technology drives around test tracks and selected highways; in mines and closed environments it already makes real sense — but on ordinary roads, with people, weather, customs paperwork and the last mile, a human is still behind the wheel. Meanwhile the US and Europe have a chronic _shortage_ of long-haul drivers: [the IRU in 2025](https://www.iru.org/news-resources/newsroom/operators-deeply-concerned-worsening-driver-shortage-new-iru-report) estimated some **2.9 million** unfilled positions across 18 markets and roughly **502,000** unfilled in Europe alone. [McKinsey](https://www.mckinsey.com/industries/automotive-and-assembly/our-insights/will-autonomy-usher-in-the-future-of-truck-freight-transportation) still writes not about a profession disappearing but about a shortfall of **80,000+** drivers in the US and hundreds of thousands in Europe — as the primary _incentive_ for automation.

![Autonomous freight transport as a technology demo, not the cancellation of logistics](/garden/real-programmers-dont-use-ai/autopilot-transport.webp)
...
[SuperJob](https://www.superjob.ru/research/articles/115495/indeks-kurera/) noted separately in 2025 that the market rate for couriers is already **24% higher** than for qualified specialists without a degree, and **12% higher** than for specialists with one.
...
Worth stressing: even after the loudest rounds of cuts, many of these giants were still _larger_ than they had been before the pandemic. [By some estimates](https://cmr.berkeley.edu/2023/03/are-tech-layoffs-a-major-disruption-or-a-just-minor-course-correction-from-past-excesses/), the combined layoffs at the largest firms rolled back only a small fraction of the staff hired during COVID — on the order of a [**few per cent**](https://news.crunchbase.com/layoffs/analysis-big-tech-pandemic-amzn-meta/) of the pandemic-era increase, not a zeroing-out of the industry. It's a correction of an overshoot, a reallocation of resources inside companies (out of experiments and pet projects, back into the core) and a reaction to macroeconomics — not a technological revolution killing demand for engineers.
...
After the [dot-com crash of **2001–2003**](https://en.wikipedia.org/wiki/Dot-com_bubble), tech lost hundreds of thousands — by some estimates [more than a million](https://pbn.com/us-tech-sector-job-cuts-jumped-in-0840192/) — jobs over a few years. In Silicon Valley, high-tech employment in **2008** was still around [**17%** below the **2001** peak](https://www.bls.gov/opub/btn/archive/after-the-dot-com-bubble-silicon-valley-high-tech-employment-and-wages-in-2001-and-2008.pdf). But US IT employment bounced back quickly after the dip: by the mid-2000s it was growing again and had [overtaken the bubble](https://link.springer.com/article/10.1057/ejis.2008.19).

![A man in a Razorfish cap holding a sign reading WILL CODE HTML FOR FOOD](/garden/real-programmers-dont-use-ai/will-code-html-for-food.webp)

Then **2008** did it again: telecoms, computing and electronics announced roughly [**187,000** job cuts](https://pbn.com/us-tech-sector-job-cuts-jumped-in-0840192/) in a single year — the highest since the tail end of the dot-com bust. The cause wasn't "a new framework appeared". It was a financial crisis and a collapse in demand.

Downturns are cyclical. AI and technology have nothing to do with it in the way they're currently being blamed. Neither 5G, nor iOS/Android, nor the arrival of Java and the slow "death" of COBOL crashed the labour market for programmers. New technology changed _what_ you write and _what you write it in_; sometimes it hurt specific niches and specific people badly — but demand for engineers overall went up, and the crashes lined up with money, interest rates, hiring bubbles and macroeconomics.
...
So that the argument doesn't look invulnerable: local deaths did happen, and they were brutal. Typesetters. Punch-card operators. Chunks of COBOL support in banks, as systems were archived or outsourced. Delphi programmers, once the market moved to web and mobile. [Flash](https://en.wikipedia.org/wiki/Adobe_Flash), when the browsers and Apple closed that chapter. Java ME, Windows Phone and Symbian, when Android and iOS simply ate the platform.

![Borland Delphi 4 in the Windows 95 era](/garden/real-programmers-dont-use-ai/delphi.webp)

![Macromedia Flash 5: when browser intros looked like the future of the web](/garden/real-programmers-dont-use-ai/flash.webp)
...
![Meme: "What is AI?" — a whiteboard covered in nested if() statements, captioned This Is AI](/garden/real-programmers-dont-use-ai/what-is-ai.webp)
...
Economics has a name for this: the [Jevons paradox](https://en.wikipedia.org/wiki/Jevons_paradox). Improving the efficiency with which a resource is used leads not to lower consumption of it but to higher. When the steam engine became more efficient, we burned more coal, not less.
