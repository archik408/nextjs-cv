...
А сам _do your :bit_, конечно, не только про мой веб-эксперимент. Дети делали свои проекты — и вот тут уже совсем про дом, привычки и «а зачем мы это жжём / выбрасываем».
...
![Умный выключатель на micro:bit: грустное и весёлое лицо на рамке, сборка и установка](/garden/vydokh-app/smart-light-switcher.webp)
...
![Умная корзина: прототип на micro:bit и концепт с улыбкой или грустью в зависимости от объёма мусора](/garden/vydokh-app/smart-trash.webp)
