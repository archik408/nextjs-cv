...
Now, I've come full circle: I'm passing on the logic and joy of creation to the next generation by teaching my children to code in <em>Scratch</em>, <em>MakeCode</em> and <em>Blockly</em>.`,
    ...
    experiences: [
      {
        ...
        listDescription: [
          ...
          'Increased NPS with 0,8 points & Retail Turnover growth of 0.25% by improving the UI based on A/B testing and UX interviews & research',
      ...
      },
      {
        ...
        period: '2021 - 2022',
        listDescription: [
          "Managed the company's 4th largest division (~200+ engineers), overseeing operations across Grodno, Belarus (~40+ engineers before company EU migration was started), and Vilnius, Lithuania",
          ...
          "As a Talent Manager, provided mentorship and career guidance to the division's top senior/lead engineers (~10 engineers), helping them formulate and achieve their professional goals using SWOT analysis and SMART method",
          'Successfully introduced and implemented OKRs (Objectives and Key Results) across the division',
          'Launched Godel JS Podcast (4 episodes were released)',
          'Launched Accessibility internal blog with weekly news and knowledge base',
        ],
      },
      {
    ...
    microbitConnector: {
      ...
      protocolAlert: {
        ...
        commands: [
          ...
          'BEEP — short non-blocking tone (v2); avoid long melodies / UntilDone over Bluetooth',
      ...
      requirements: [
        'BBC micro:bit v2 with UART firmware: bluetooth.startUartService() plus listeners.',
        'USB needs serial.onDataReceived; Bluetooth needs bluetooth.onUartDataReceived (not serial).',
        'For Bluetooth: No Pairing Required in MakeCode, Chrome/Edge on desktop or Android.',
    ...
    yandexAliceSkillsCatalogTitle: 'Available skills and commands',
    yandexAliceMicrobitTitle: 'My Microbit',
    yandexAliceMicrobitDescription: 'Send commands to Microbit and receive Alice’s replies.',
    yandexAliceMicrobitCommandsTitle: 'My Microbit — commands',
    yandexAliceMicrobitCommands: [
      'улыбнись → SMILE',
      'грусти → SAD',
      'издай звук → BEEP',
      'логотип → LOGO',
      ...
      'нарисуй нет → NO',
      'пинг → PING',
      'нажми а / нажми б → BTN_A / BTN_B',
      'напиши привет → TEXT:привет',
      'иконка сердце → ICON:heart',
      'статус / помощь / пока',
    ],
    ...
    yandexAliceWitcherCommandsTitle: 'The Witcher for Matvey — commands',
    yandexAliceWitcherCommands: [
      'Choose a school: Cat, Wolf, Viper, Griffin, Manticore, Bear',
      'In battle pick one of three weapons/tools',
      '3 lives — a wrong choice costs one life',
      'заново — start a new hunt',
      'помощь — how to play',
    ],
...
Теперь я замкнул круг: передаю опыт и радость творчества следующему поколению, обучая своих детей программированию на <em>Scratch</em>, <em>MakeCode</em> и <em>Blockly</em>.`,
    ...
    experiences: [
      {
        ...
        listDescription: [
          ...
          'Повышение показателя NPS на 0,8 пункта и рост розничной выручки на 0,25% за счет улучшения пользовательского интерфейса на основе A/B-тестирования, UX-интервью и исследований',
          ...
          'Организую непрерывный мониторинг фронтенда через Sentry и связанные инструменты для стабильности, улучшения Core Web Vitals и общего качества',
      ...
      },
      {
        ...
        period: '2021 - 2022',
        listDescription: [
          'Управлял 4-м по величине подразделением компании (200+ инженеров), курируя операции в Гродно, Беларусь (40+ инженеров до массовой эмиграции компании в EU) и Вильнюсе, Литва',
          ...
          'Как Talent Manager наставлял ведущих senior-инженеров подразделения (10 инжененров), помогая формулировать и достигать целей через SWOT и SMART',
          'Успешно внедрил OKR (Objectives and Key Results) в подразделении',
          'Запустил подкаст Godel JS Podcast (выпущено 4 эпизода при мне)',
          'Запустил внутренний блог по вопросам доступности (Accessibility/a11y) с еженедельными новостями и базой знаний',
        ],
      },
      {
        role: 'Senior Web Engineer',
    ...
    microbitConnector: {
      ...
      protocolAlert: {
        ...
        commands: [
          ...
          'BEEP — короткий неблокирующий тон (v2); длинные мелодии / UntilDone по Bluetooth рвут связь',
      ...
      requirements: [
        'BBC micro:bit v2 с UART-прошивкой: bluetooth.startUartService() и обработчики команд.',
        'USB — serial.onDataReceived; Bluetooth — bluetooth.onUartDataReceived (не serial).',
        'Для Bluetooth: No Pairing Required в MakeCode, Chrome/Edge на desktop или Android.',
    ...
    yandexAliceSkillsCatalogTitle: 'Доступные навыки и команды',
    ...
    yandexAliceMicrobitCommandsTitle: 'Мой Микробит — команды',
    yandexAliceMicrobitCommands: [
      'улыбнись → SMILE',
      'грусти → SAD',
      'издай звук → BEEP',
    ...
    yandexAliceWitcherCommandsTitle: 'Ведьмак для Матвея — команды',
    yandexAliceWitcherCommands: [
      'Выбор школы: Кота, Волка, Змеи, Грифона, Мантикоры, Медведя',
      'В бою — одно из трёх оружий или средств',
      '3 жизни — ошибка отнимает жизнь',
      'заново — новая охота',
      'помощь — как играть',
    ],
