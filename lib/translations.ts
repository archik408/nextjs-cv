...
Now, I've come full circle: I'm passing on the logic and joy of creation to the next generation by teaching my children to code in <strong>Scratch</strong>, <strong>MakeCode</strong> and <strong>Blockly</strong>.`,
...
Теперь я замкнул круг: передаю опыт и радость творчества следующему поколению, обучая своих детей программированию на <strong>Scratch</strong>, <strong>MakeCode</strong> и <strong>Blockly</strong>.`,
