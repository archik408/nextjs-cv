      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold mb-4">{t.ocrTitle}</h1>
            <p className="text-lg text-gray-600 dark:text-gray-400">{t.ocrSubtitle}</p>
          </div>
            ...
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center">
              {!selectedImage ? (
                <>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">{t.ocrUploadText}</p>
                  <input
                    ref={fileInputRef}
                    type="file"
                    accept="image/*"
          ...
          {recognizedText && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-semibold mb-4">{t.ocrResult}</h2>
          ...
          <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
            <h3 className="text-lg font-semibold mb-2 text-blue-800 dark:text-blue-200">
              {t.ocrSupportedFormats}
            </h3>
            <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
              {t.ocrFormatsList.map((item, index) => (
