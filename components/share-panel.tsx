  ...
  return (
    <div className={`flex flex-wrap items-center gap-2 ${className || ''}`}>
      <button
        ...
        className="shadow-lg dark:shadow-xl/20 inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 transition-colors"
